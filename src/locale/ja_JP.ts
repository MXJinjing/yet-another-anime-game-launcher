...
export const ja_JP: typeof zh_CN = {
  ...
  GAME_STARTING: "ゲームを起動中",
  GAME_CRASHED: "ゲームのクラッシュを検出しました",
  GAME_CRASHED_DESC: "ゲーム環境と起動設定が正しいか確認してください。",
  GAME_CRASHED_IGNORE: "無視",
  GAME_CRASHED_SETTINGS: "ゲーム設定を開く",
  RUNTIME_REPLACEMENT_ERROR: "一時置換ファイルのエラー",
  RUNTIME_REPLACEMENT_ERROR_DESC:
    "ゲーム起動前に一時置換ファイルを確認できませんでした。下のエラーを確認し、ゲーム設定で置換ファイルのパスを修正してください。",
  GAME_RUNNING: "ゲーム実行中",
  GAME_RECOVERING: "復元中",
  ...
  SETTING_GAME_WINE_UNSAVED:
    "Wine 設定に保存されていない変更があります。保存せずに離れますか？",
  SETTING_GAME_WINE_ENABLE: "専用 Wine 環境を有効化",
  SETTING_GAME_WINE_ENABLE_DESC:
    "このゲーム専用の Wine prefix を作成して固定します。オフの場合はグローバルの Wine と prefix に従います。",
  SETTING_GAME_WINE_AUTO: "自動選択",
  SETTING_GAME_WINE: "カスタム Wine",
  SETTING_GAME_WINE_REMOVE_PREFIX: "ゲーム専用 Wine 環境を削除",
  SETTING_GAME_WINE_REMOVE_PREFIX_DESC:
    "ゲームはグローバル環境に戻りました。専用 Wine prefix を削除して容量を解放します（データは切替時に同期済み）。",
  SETTING_GAME_WINE_MIGRATE: "既存データを移行",
  SETTING_GAME_WINE_MIGRATE_DESC:
    "このゲーム専用の Wine 環境を初めて作成する際、現在の prefix をコピーしてゲーム内設定と端末情報を引き継ぎます。",
  SETTING_GAME_WINE_PREPARE_FAILED:
    "Wine 環境の準備に失敗しました。以前の選択を維持します。",
  ...
  SETTING_METALFX_DXMT_ONLY: "DXMT 版 Wine でのみ有効",
  ...
  SETTING_CUSTOM_ENVIRONMENT_VARIABLES_TITLE: "カスタム環境変数",
  SETTING_CUSTOM_ENVIRONMENT_VARIABLES_DESC:
    "ゲーム起動時に Wine プロセスへカスタム環境変数を追加します。",
  SETTING_CUSTOM_ENVIRONMENT_VARIABLES_HEADER_ENABLED: "有効",
  SETTING_CUSTOM_ENVIRONMENT_VARIABLES_HEADER_KEY: "環境変数キー",
  SETTING_CUSTOM_ENVIRONMENT_VARIABLES_HEADER_VALUE: "値",
  SETTING_CUSTOM_ENVIRONMENT_VARIABLES_HEADER_DELETE: "削除",
  SETTING_CUSTOM_ENVIRONMENT_VARIABLES_ROW_ENABLED:
    "環境変数 {0} 行目を有効にする",
  SETTING_CUSTOM_ENVIRONMENT_VARIABLES_DELETE_ROW: "この行を削除",
  SETTING_CUSTOM_ENVIRONMENT_VARIABLES_ADD_ROW: "行を追加",
