...
export const vi_VN: typeof zh_CN = {
  ...
  SETTING_GAME_WINE_UNSAVED: "Cài đặt Wine có thay đổi chưa lưu. Vẫn rời đi?",
  SETTING_GAME_WINE_ENABLE: "Bật môi trường Wine riêng",
  SETTING_GAME_WINE_ENABLE_DESC:
    "Tạo và cố định Wine prefix riêng cho game này; khi tắt sẽ dùng Wine và prefix chung.",
  SETTING_GAME_WINE_AUTO: "Tự động",
  SETTING_GAME_WINE: "Wine tùy chỉnh",
  SETTING_GAME_WINE_REMOVE_PREFIX: "Xóa môi trường Wine riêng của game",
  SETTING_GAME_WINE_REMOVE_PREFIX_DESC:
    "Game đã quay lại môi trường chung. Xóa Wine prefix riêng để giải phóng dung lượng.",
  SETTING_GAME_WINE_MIGRATE: "Chuyển dữ liệu hiện có",
  SETTING_GAME_WINE_MIGRATE_DESC:
    "Khi tạo Wine prefix riêng cho game này lần đầu, prefix hiện tại sẽ được sao chép để giữ cài đặt và dữ liệu thiết bị.",
  SETTING_GAME_WINE_PREPARE_FAILED:
    "Không thể chuẩn bị môi trường Wine. Lựa chọn trước đó được giữ nguyên.",
  ...
  SETTING_METALFX_DXMT_ONLY: "Chỉ hoạt động với Wine bản DXMT",
