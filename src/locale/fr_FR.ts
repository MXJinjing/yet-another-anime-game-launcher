...
export const fr_FR: typeof zh_CN = {
  ...
  BOOT_INITIALIZING_GAME_CLIENT:
    "Chargement de la configuration du canal de jeu",
  ...
  SETTING_USE_D3D12: "Activer DirectX 12",
  SETTING_USE_D3D12_DESC: "Lancer le jeu avec DirectX 12 activé.",
  SETTING_NAP_METALFX: "Activer MetalFX",
  SETTING_NAP_METALFX_DESC:
    "Utiliser MetalFX à la place de DLSS, avec prise en charge du ray tracing.",
  SETTING_NAP_REQUIRES_GPTK3: "Nécessite Game Porting Toolkit 3 (GPTK3).",
  ...
  SETTING_GAME_WINE_UNSAVED:
    "Les réglages Wine comportent des modifications non enregistrées. Quitter ?",
  SETTING_GAME_WINE_ENABLE: "Activer un environnement Wine dédié",
  SETTING_GAME_WINE_ENABLE_DESC:
    "Crée et fixe un préfixe Wine dédié à ce jeu ; désactivé, il suit le Wine et le préfixe globaux.",
  SETTING_GAME_WINE_AUTO: "Automatique",
  SETTING_GAME_WINE: "Wine personnalisé",
  SETTING_GAME_WINE_REMOVE_PREFIX: "Supprimer l'environnement Wine du jeu",
  SETTING_GAME_WINE_REMOVE_PREFIX_DESC:
    "Le jeu utilise à nouveau l'environnement global. Supprimez son préfixe Wine pour libérer de l'espace.",
  SETTING_GAME_WINE_MIGRATE: "Migrer les données existantes",
  SETTING_GAME_WINE_MIGRATE_DESC:
    "Lors de la première création d'un préfixe Wine dédié à ce jeu, le préfixe actuel est copié pour conserver les réglages et les données de l'appareil.",
  SETTING_GAME_WINE_PREPARE_FAILED:
    "Échec de la préparation de l'environnement Wine. La sélection précédente est conservée.",
  ...
  SETTING_METALFX_DXMT_ONLY: "Fonctionne uniquement avec un Wine DXMT",
  ...
  LAUNCH_WITHOUT_UPDATE: "Lancer sans mettre à jour",
  ...
  SETTING_RUNTIME_REPLACEMENT_TITLE:
    "Remplacer des fichiers pendant l’exécution du jeu",
  SETTING_RUNTIME_REPLACEMENT_DESC:
    "Avant le lancement, les fichiers sélectionnés sont copiés par-dessus les fichiers cibles du dossier du jeu et conservés pendant l’exécution du jeu. Les originaux sont restaurés après la fermeture du jeu.",
  SETTING_RUNTIME_REPLACEMENT_HEADER_ENABLED: "Activé",
  SETTING_RUNTIME_REPLACEMENT_HEADER_TARGET: "Fichier à remplacer",
  SETTING_RUNTIME_REPLACEMENT_HEADER_REPLACEMENT: "Fichier de remplacement",
  SETTING_RUNTIME_REPLACEMENT_HEADER_DELETE: "Supprimer",
  SETTING_RUNTIME_REPLACEMENT_ROW_ENABLED: "Activer la ligne {0}",
  SETTING_RUNTIME_REPLACEMENT_PICK_TARGET: "Choisir le fichier à remplacer",
  ...
  AHEAD_OF_LATEST_TITLE: "Plus récent que la dernière version",
  AHEAD_OF_LATEST_JOKE:
    "Pendant que la version officielle sort encore au compte-gouttes 🐌, tu es déjà sur la génération suivante 🚀. Reste discret, pas de spoil 🤫.",
  ...
  LICENSE_VIEW_ONLINE: "Voir en ligne",
