...
export const es_ES: typeof zh_CN = {
  ...
  SETTING_BLOCK_ALL_NET: en.SETTING_BLOCK_ALL_NET,
  SETTING_SUDOERS_SETUP: en.SETTING_SUDOERS_SETUP,
  SETTING_SUDOERS_DESC: en.SETTING_SUDOERS_DESC,
  SETTING_COPY: en.SETTING_COPY,
  SETTING_COPIED: en.SETTING_COPIED,
  SETTING_COPY_SUDOERS: en.SETTING_COPY_SUDOERS,
