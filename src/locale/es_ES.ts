...
export const es_ES: typeof zh_CN = {
  ...
  SETTING_USE_D3D12: "Activar DirectX 12",
  SETTING_USE_D3D12_DESC: "Inicia el juego con DirectX 12 activado.",
  SETTING_NAP_METALFX: "Activar MetalFX",
  SETTING_NAP_METALFX_DESC:
    "Usar MetalFX en lugar de DLSS, con compatibilidad con trazado de rayos.",
  SETTING_NAP_REQUIRES_GPTK3: "Requiere Game Porting Toolkit 3 (GPTK3).",
  ...
  SETTING_GAME_WINE_UNSAVED:
    "Los ajustes de Wine tienen cambios sin guardar. ¿Salir igualmente?",
  SETTING_GAME_WINE_ENABLE: "Activar un entorno Wine propio",
  SETTING_GAME_WINE_ENABLE_DESC:
    "Crea y fija un prefijo Wine propio para este juego; desactivado sigue el Wine y el prefijo globales.",
  SETTING_GAME_WINE_AUTO: "Automático",
  SETTING_GAME_WINE: "Wine personalizado",
  SETTING_GAME_WINE_REMOVE_PREFIX: "Eliminar el entorno Wine del juego",
  SETTING_GAME_WINE_REMOVE_PREFIX_DESC:
    "El juego vuelve al entorno global. Elimina su prefijo Wine para liberar espacio.",
  SETTING_GAME_WINE_MIGRATE: "Migrar datos existentes",
  SETTING_GAME_WINE_MIGRATE_DESC:
    "Al crear por primera vez un prefijo Wine propio para este juego se copia el prefijo actual para conservar los ajustes y los datos del dispositivo.",
  SETTING_GAME_WINE_PREPARE_FAILED:
    "No se pudo preparar el entorno Wine. Se mantiene la selección anterior.",
  ...
  SETTING_METALFX_DXMT_ONLY: "Solo funciona con un Wine DXMT",
  ...
  PREDOWNLOAD_DONE: en.PREDOWNLOAD_DONE,
  SETTING_PREDOWNLOAD: en.SETTING_PREDOWNLOAD,
  SETTING_PREDOWNLOAD_VERSION: en.SETTING_PREDOWNLOAD_VERSION,
  SETTING_PREDOWNLOAD_SIZE: en.SETTING_PREDOWNLOAD_SIZE,
  SETTING_DELETE_PREDOWNLOAD: en.SETTING_DELETE_PREDOWNLOAD,
  ...
  AUTHORIZATION_PROMPT_HOSTS_HELPER_INSTALL:
    en.AUTHORIZATION_PROMPT_HOSTS_HELPER_INSTALL,
  AUTHORIZATION_PROMPT_HOSTS_HELPER_REREGISTER:
    en.AUTHORIZATION_PROMPT_HOSTS_HELPER_REREGISTER,
  AUTHORIZATION_PROMPT_HOSTS_HELPER_UNINSTALL:
    en.AUTHORIZATION_PROMPT_HOSTS_HELPER_UNINSTALL,
  AUTHORIZATION_PROMPT_TEMPORARY_HOSTS: en.AUTHORIZATION_PROMPT_TEMPORARY_HOSTS,
  AUTHORIZATION_PROMPT_MANAGED_HOSTS: en.AUTHORIZATION_PROMPT_MANAGED_HOSTS,
  AUTHORIZATION_PROMPT_RECONCILE_HOSTS: en.AUTHORIZATION_PROMPT_RECONCILE_HOSTS,
  AUTHORIZATION_PROMPT_REPLACE_LAUNCHER:
    en.AUTHORIZATION_PROMPT_REPLACE_LAUNCHER,
  AUTHORIZATION_PROMPT_REMOVE_QUARANTINE:
    en.AUTHORIZATION_PROMPT_REMOVE_QUARANTINE,
