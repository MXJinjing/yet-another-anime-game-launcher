...
export const th_TH: typeof zh_CN = {
  ...
  GAME_STARTING: "กำลังเริ่มเกม",
  GAME_CRASHED: "ตรวจพบว่าเกมหยุดทำงาน",
  GAME_CRASHED_DESC:
    "โปรดตรวจสอบการตั้งค่าสภาพแวดล้อมและการเริ่มเกมว่าถูกต้องหรือไม่",
  GAME_CRASHED_IGNORE: "ละเว้น",
  GAME_CRASHED_SETTINGS: "ไปที่การตั้งค่าเกม",
  RUNTIME_REPLACEMENT_ERROR: "ข้อผิดพลาดของไฟล์แทนที่ชั่วคราว",
  RUNTIME_REPLACEMENT_ERROR_DESC:
    "ไม่สามารถตรวจสอบไฟล์แทนที่ชั่วคราวก่อนเริ่มเกมได้ โปรดตรวจสอบข้อผิดพลาดด้านล่างและแก้ไขเส้นทางไฟล์ในหน้าตั้งค่าเกม",
  ...
  SETTING_GAME_WINE_UNSAVED:
    "การตั้งค่า Wine มีการเปลี่ยนแปลงที่ยังไม่บันทึก ต้องการออกโดยไม่บันทึกหรือไม่",
  SETTING_GAME_WINE_ENABLE: "เปิดใช้สภาพแวดล้อม Wine แยก",
  SETTING_GAME_WINE_ENABLE_DESC:
    "สร้างและใช้ Wine prefix เฉพาะของเกมนี้ เมื่อปิดจะใช้ Wine และ prefix ส่วนกลาง",
  SETTING_GAME_WINE_AUTO: "เลือกอัตโนมัติ",
  SETTING_GAME_WINE: "Wine ที่กำหนดเอง",
  SETTING_GAME_WINE_REMOVE_PREFIX: "ลบสภาพแวดล้อม Wine ของเกม",
  SETTING_GAME_WINE_REMOVE_PREFIX_DESC:
    "เกมกลับไปใช้สภาพแวดล้อมส่วนกลางแล้ว ลบ Wine prefix เฉพาะของเกมเพื่อคืนพื้นที่",
  SETTING_GAME_WINE_MIGRATE: "ย้ายข้อมูลเดิม",
  SETTING_GAME_WINE_MIGRATE_DESC:
    "เมื่อสร้าง Wine prefix แยกให้เกมนี้ครั้งแรก ระบบจะคัดลอกจาก prefix ปัจจุบันเพื่อเก็บการตั้งค่าและข้อมูลอุปกรณ์",
  SETTING_GAME_WINE_PREPARE_FAILED:
    "เตรียมสภาพแวดล้อม Wine ไม่สำเร็จ ระบบจะเก็บค่าที่เลือกไว้เดิม",
  ...
  SETTING_METALFX_DXMT_ONLY: "ทำงานเฉพาะกับ Wine เวอร์ชัน DXMT",
  ...
  SETTING_CUSTOM_ENVIRONMENT_VARIABLES_TITLE: "ตัวแปรสภาพแวดล้อมที่กำหนดเอง",
  SETTING_CUSTOM_ENVIRONMENT_VARIABLES_DESC:
    "เพิ่มตัวแปรสภาพแวดล้อมที่กำหนดเองให้กับโปรเซส Wine เมื่อเริ่มเกม",
  SETTING_CUSTOM_ENVIRONMENT_VARIABLES_HEADER_ENABLED: "เปิดใช้",
  SETTING_CUSTOM_ENVIRONMENT_VARIABLES_HEADER_KEY: "คีย์ตัวแปรสภาพแวดล้อม",
  SETTING_CUSTOM_ENVIRONMENT_VARIABLES_HEADER_VALUE: "ค่า",
  SETTING_CUSTOM_ENVIRONMENT_VARIABLES_HEADER_DELETE: "ลบ",
  SETTING_CUSTOM_ENVIRONMENT_VARIABLES_ROW_ENABLED:
    "เปิดใช้แถวตัวแปรสภาพแวดล้อม {0}",
  SETTING_CUSTOM_ENVIRONMENT_VARIABLES_DELETE_ROW: "ลบแถวนี้",
  SETTING_CUSTOM_ENVIRONMENT_VARIABLES_ADD_ROW: "เพิ่มแถว",
  ...
  DOWNLOAD_STATUS_VERIFYING: "กำลังตรวจสอบ",
  ...
  NOTIFICATION_AUTHORIZATION_CANCELLED: "งานล้มเหลวเนื่องจากยกเลิกการอนุญาต",
