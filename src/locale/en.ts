...
export const en: typeof zh_CN = {
  ...
  GAME_CRASHED: "Game crash detected",
  GAME_CRASHED_DESC:
    "Please check whether the current game environment and launch settings are correct.",
  GAME_CRASHED_IGNORE: "Ignore",
  GAME_CRASHED_SETTINGS: "Go to game settings",
  RUNTIME_REPLACEMENT_ERROR: "Runtime replacement file error",
  RUNTIME_REPLACEMENT_ERROR_DESC:
    "The launcher could not validate a temporary replacement file before starting the game. Check the error below and update the replacement path in game settings.",
  ...
  SETTING_NAP_METALFX_DESC:
    "Use MetalFX instead of DLSS, with ray tracing support.",
  ...
  SETTING_CUSTOM_ENVIRONMENT_VARIABLES_TITLE: "Custom environment variables",
  SETTING_CUSTOM_ENVIRONMENT_VARIABLES_DESC:
    "Add custom environment variables to the Wine process when launching the game.",
  SETTING_CUSTOM_ENVIRONMENT_VARIABLES_HEADER_ENABLED: "Enabled",
  SETTING_CUSTOM_ENVIRONMENT_VARIABLES_HEADER_KEY: "Environment variable key",
  SETTING_CUSTOM_ENVIRONMENT_VARIABLES_HEADER_VALUE: "Value",
  SETTING_CUSTOM_ENVIRONMENT_VARIABLES_HEADER_DELETE: "Delete",
  SETTING_CUSTOM_ENVIRONMENT_VARIABLES_ROW_ENABLED:
    "Enable environment variable row {0}",
  SETTING_CUSTOM_ENVIRONMENT_VARIABLES_DELETE_ROW: "Delete this row",
  SETTING_CUSTOM_ENVIRONMENT_VARIABLES_ADD_ROW: "Add row",
